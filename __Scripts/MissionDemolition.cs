...
public class MissionDemolition : MonoBehaviour
{
    ...
    public Text uitBest;  // The UIText_Best Text (Best Score display)
    ...
    public int bestScore = 100; // Best (lowest) shots taken score
    ...
    void UpdateGUI() {
        ...
        uitBest.text = "Best Score: " + bestScore;
    }
    ...
    void NextLevel() {                                                  
        level++;
         if (level == levelMax){
            // BEFORE resetting shotsTaken, check for new best score
